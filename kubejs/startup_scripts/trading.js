...
onEvent('item.registry', event => {
    ...
    profession("Mining", 0x1C1124, 0x88FFF7, [
        ...
        { in: "16x beyond_earth:moon_stone", out: S(2) }
    ])
    ...
    while (true) {
        ...
        simple("Purpur Block", "16x rechiseled:purpur_dotted", 2, S, 0x211C10, 0x604B43)
        simple("Dark Obsidian Block", "16x rechiseled:obsidian_dark", 4, S, 0x71706E, 0x9D9A98)
