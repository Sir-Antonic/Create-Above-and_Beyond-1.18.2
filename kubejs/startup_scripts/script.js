...
onEvent('item.registry', event => {
    ...
    event.create('pipe_mod_util').texture("kubejs:item/pipe_mod_util").displayName('Utility Pipe Module')
    event.create('pipe_mod_util_1').texture("kubejs:item/pipe_mod_util_1").displayName('Brass Pipe Module')
    event.create('pipe_mod_util_2').texture("kubejs:item/pipe_mod_util_2").displayName('Invar Pipe Module')
    event.create('pipe_mod_util_3').texture("kubejs:item/pipe_mod_util_3").displayName('Enderium Pipe Module')
    ...
    types.forEach(name => {
        ...
        event.create('growing_' + e + '_seed', 'create:sequenced_assembly').texture("ae2:item/crystal_seed_" + e).displayName(name + ' Quartz Seed')
        event.create('tiny_' + e + '_crystal').texture("ae2:item/crystal_seed_" + e + "2").displayName('Tiny ' + name + ' Quartz Crystal')
        event.create('growing_tiny_' + e + '_crystal', 'create:sequenced_assembly').texture("ae2:item/crystal_seed_" + e + "2").displayName('Tiny ' + name + ' Quartz Crystal')
        event.create('small_' + e + '_crystal').texture("ae2:item/crystal_seed_" + e + "3").displayName('Small ' + name + ' Quartz Crystal')
        event.create('growing_small_' + e + '_crystal', 'create:sequenced_assembly').texture("ae2:item/crystal_seed_" + e + "3").displayName('Small ' + name + ' Quartz Crystal')
    })
...
onEvent('block.registry', event => {
    event.create('enderium_casing'.model('kubejs:/enderium_casing').material('metal').hardness(4.0).displayName('Ender Casing'))
    ...
    event.create(`accelerator_glowstone`)
        ...
        .model("kubejs:block/accelerator")
...
onEvent('fluid.registry', event => {
    ...
    event.create('crude_oil')
        .stillTexture('kubejs:fluid/crude_oil_still')
        .flowingTexture('kubejs:fluid/crude_oil_flow')
    ...
    event.create('liquid_oxygen')
        .stillTexture('kubejs:fluid/oxygen_still')
        .flowingTexture('kubejs:fluid/oxygen_flow')
        .bucketColor(0xEBEBEB)
        .displayName('Liquid Oxygen')

    event.create('liquid_smoke')
        .stillTexture('kubejs:fluid/oxygen_still')
        .flowingTexture('kubejs:fluid/oxygen_flow')
        .bucketColor(0xEBEBEB)
